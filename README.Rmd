...
Version 0.2.4 has changed the function naming convention to `crop_*`. The old functions are still available and work the same way but will be deprecated at some stage.
